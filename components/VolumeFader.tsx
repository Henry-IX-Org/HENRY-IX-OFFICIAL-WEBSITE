...
export function VolumeFader({
  ...
  return (
    <div ref={containerRef} className="relative flex-grow min-h-[44px] max-h-[120px] w-full max-w-[28px] min-w-[14px] bg-black border border-zinc-900 hover:border-zinc-700 focus-within:border-zinc-500 rounded-none flex items-center justify-center overflow-hidden transition-colors">
      <input 
        type="range"
        min="0"
        max="100"
